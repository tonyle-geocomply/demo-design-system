...
const GcSpinner = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  components.forEach(tagName => { switch (tagName) {
    case "gc-spinner":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GcSpinner);
      }
      break;
  } });
}

export { GcSpinner as G, defineCustomElement as d };
