...
const GcDragContainer = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["gc-drag-container"];
  components.forEach(tagName => { switch (tagName) {
    case "gc-drag-container":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GcDragContainer);
      }
      break;
  } });
}

export { GcDragContainer as G, defineCustomElement as d };
