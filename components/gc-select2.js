...
const GcSelect = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    return (h(Host, { id: this.gcId, "has-value": this.hasValue(), "has-focus": this.hasFocus, "is-open": this.isOpen, position: this.position }, h("div", { class: { 'gc__dropdown': true, 'select': true, [this.position]: true, 'is-open': this.isOpen } }, h("div", { class: {
