    ...
    this.getColumns().forEach(col => {
      if (this.showingColumns[col.name]) {
        ...
        const colEl = (h("div", { onClick: () => {
          ...
          if (!this.sortable)
            return;
          return (h("div", { class: "gc__table-arrow" }, h("gc-icon", { class: { disabled: this.sortBy === col.name && this.sortOrder === 'desc' }, name: "fa-regular fa-chevron-up", size: "sm" }), h("gc-icon", { class: { 'disabled': this.sortBy === col.name && this.sortOrder === 'asc', 'down-arrow': true }, name: "fa-regular fa-chevron-down", size: "sm" })));
        })()))));
