...
import { g as getIconExtension, a as getAcceptTypes } from './utils.js';
import { d as defineCustomElement$4 } from './gc-button2.js';
import { d as defineCustomElement$3 } from './gc-icon2.js';
import { d as defineCustomElement$2 } from './gc-progress2.js';
...
function defineCustomElement$1() {
  ...
  const components = ["gc-upload", "gc-button", "gc-icon", "gc-progress"];
  components.forEach(tagName => { switch (tagName) {
    case "gc-upload":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GcUpload$1);
      }
      break;
    case "gc-button":
      if (!customElements.get(tagName)) {
...
const GcUpload = GcUpload$1;
const defineCustomElement = defineCustomElement$1;

export { GcUpload, defineCustomElement };
