import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-8d6b55b1.js';
import { d as debounceEvent, i as isMobile, a as isOutOfViewport } from './utils-850968fe.js';
...
const GcButton = class {
  ...
  render() {
    return (h("button", { class: this.getClassName(), id: this.gcId }, this.icon && (h("span", { class: "gc__button-icon" }, h("gc-icon", { color: this.getColorIcon(), name: this.icon }))), h("span", { class: "gc__button-text" }, h("slot", null))));
  }
};
  ...
  async fetchSvg() {
    if (this.name) {
      ...
      try {
        switch (this.name) {
          case 'caret-down':
            svgName = await import('./caret-down-97dd7da2.js');
            break;
          case 'caret-up':
            svgName = await import('./caret-up-93c5ede9.js');
            break;
          case 'search':
            svgName = await import('./search-865e958b.js');
            break;
          case 'clear-search':
            svgName = await import('./clear-search-790f466e.js');
            break;
          case 'table-setting':
            svgName = await import('./table-setting-a795a0d1.js');
            break;
          case 'advanced-filter':
            svgName = await import('./advanced-filter-103d6d87.js');
            break;
          case 'anchor':
            svgName = await import('./anchor-454a3130.js');
            break;
          case 'calendar':
            svgName = await import('./calendar-e72ed67c.js');
            break;
          case 'money':
            svgName = await import('./money-1954ebf6.js');
            break;
          case 'fraud':
            svgName = await import('./fraud-c51344a6.js');
            break;
          case 'right-arrow':
            svgName = await import('./right-arrow-45b641d3.js');
            break;
          case 'square-info':
            svgName = await import('./square-info-206ab3e9.js');
            break;
          case 'user-group':
            svgName = await import('./user-group-b2323262.js');
            break;
          case 'bell':
            svgName = await import('./bell-8d57c36a.js');
            break;
          case 'home':
            svgName = await import('./home-6a3da181.js');
            break;
          case 'circle-question':
            svgName = await import('./circle-question-35eea491.js');
            break;
          default:
            this.svg = '';
            break;
...
export { GcButton as gc_button, GcCheckbox as gc_checkbox, GcFormField as gc_form_field, GcH1 as gc_h1, GcH2 as gc_h2, GcH3 as gc_h3, GcIcon as gc_icon, GcInput as gc_input, GcLabel as gc_label, GcMenu as gc_menu, GcMenuItem as gc_menu_item, GcOl as gc_ol, GcSelect as gc_select, GcTag as gc_tag, GcUl as gc_ul };
