...
const GcCellExpandable = class {
  ...
  render() {
    return (h(Host, null, h("header", { class: { 'gc__head-opening': this.open, 'gc__head': true }, onClick: () => this.toggle() }, h("div", { class: "gc__step-item-title" }, h("div", { class: { 'transitioning-rotate': this.open, 'gc__step-item-icon': true }, onTransitionEnd: () => this.handleTransitionEnd() }, h("gc-icon", { name: "fa-regular fa-chevron-down", color: "var(--gc-color-primary)", size: "12px" })), h("div", { class: "gc__step-item-title--content" }, h("div", null, this.fieldName, ": ", h("b", null, this.value)), h("div", { class: "divider" }), h("gc-dropdown", { trigger: "hover", positions: "bottom-end" }, h("gc-link", null, h("b", null, this.total, " total ", this.totalText)), h("div", { slot: "gc__dropdown-content", style: { padding: '16px' } }, h("div", null, this.tooltipMessage)))), h("div", { class: "gc__step-item-title--entry" }, "Showing last ", this.numberOfEntryPerPage, " of ", this.total, " entries"))), h("section", { class: { 'gc__steps-section': true, 'transitioning': this.transitioning, 'open': this.open }, style: this.style }, h("div", null, h("slot", null)))));
  }
