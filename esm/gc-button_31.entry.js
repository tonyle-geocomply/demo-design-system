    ...
    columnsWithPos.forEach((col, i) => {
      if (this.showingColumns[col.name]) {
        ...
        const colEl = (h("div", { onClick: () => {
          ...
          }, class: { gc__col: true, sort: this.sortBy === col.name }, style: { width: colWidth, background: this.background, padding: col.padding } }, h("div", { class: "col-content" }, h("div", { class: "col-text" }, col.label), h("div", { class: "col-actions" }, (() => {
