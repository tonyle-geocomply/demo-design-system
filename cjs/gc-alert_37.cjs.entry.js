...
const GcCard = class {
  ...
  render() {
    return (index$1.h("div", { class: this.getClassName(), style: { width: this.width, height: this.height, background: this.background } }, this.heading || this.icon ? (index$1.h("div", { class: "gc__card-heading" }, this.icon && index$1.h("gc-icon", { color: "var(--gc-color-primary)", name: this.icon }), this.heading || '')) : null, index$1.h("slot", null)));
  }
};
...
const GcFormField = class {
  ...
  renderField() {
    switch (this.type) {
      case 'select':
        return (index$1.h("gc-select", { background: this.background, search: this.search, items: this.items, "gc-id": this.gcId, "gc-name": this.gcName, value: this.value, defaultValue: this.defaultValue, disabled: this.disabled, placeholder: this.placeholder, "onGc:change": e => this.handleChange(e), "onGc:search": e => this.handleSearchSelect(e), "is-error": !!this.errorText || this.isError }));
      case 'textarea':
...
const GcMenuItem = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.gcMenuItemClick = index$1.createEvent(this, "gc:menu-item-click", 7);
    this.tabindex = 1;
    /**
     * If true, the user cannot interact with the button. Defaults to `false`.
     */
...
const GcSelect = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { id: this.gcId, "has-value": this.hasValue(), "has-focus": this.hasFocus, "is-open": this.isOpen, position: this.position }, index$1.h("div", { class: { 'dropdown': true, 'select': true, [this.position]: true, 'is-open': this.isOpen, 'gc__select-disabled': this.disabled } }, index$1.h("div", { onClick: evt => {
      ...
      }, style: { background: this.background } }, index$1.h("div", { class: "slot-container start" }, index$1.h("slot", { name: "start" })), (() => {
    ...
    if (this.items) {
      ...
      return (index$1.h("gc-menu", { class: "menu", empty: filteredItems.length == 0, ref: el => (this.menuElm = el) }, (() => {
        return filteredItems.map(item => {
          return (index$1.h("gc-menu-item", { background: this.background, disabled: item.disabled, dot: item.dot, color: item.color, value: item.value, label: item.label }, item.label || item.value));
        });
      })()));
    }
  }
...
const GcTable = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { "data-loading": this.isLoading ? 'true' : 'false' }, this.renderSettingColumns(), index$1.h("div", { class: { 'is-loading': this.isLoading, 'table-data': true } }, this.isLoading && (index$1.h("div", { class: "loading-section" }, index$1.h("gc-spinner", null))), conditionShowing ? (index$1.h("div", { style: { border: this.isNoBorderedAll && !this.isStripe ? '0' : '' }, class: {
        'gc__table': true,
  ...
  renderEmptyState() {
    ...
    if (this.isLoading) {
      return (index$1.h("div", { class: { 'empty-table': true, 'empty-table-no-bordered': this.isNoBorderedEmptyState, 'gc__table-loading': this.isLoading } }, index$1.h("div", { class: "gc__loading-distance" })));
    }
...
const GcTagGroup = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, null, index$1.h("div", { class: "gc__keep-tags" }, index$1.h("slot", { name: "keep-tags" })), index$1.h("gc-dropdown", null, index$1.h("div", { onClick: () => this.handleToggle(), class: "show-more-text", style: { width: this.widthOfBlock } }, text), index$1.h("div", { slot: "gc__dropdown-content" }, this.headingText && index$1.h("div", { class: "gc__dropdown-heading" }, this.headingText), index$1.h("div", { class: "gc__dropdown-block", style: { maxWidth: this.maxWidth } }, index$1.h("slot", null))))));
  }
  get element() { return index$1.getElement(this); }
};
...
exports.gc_tag_group = GcTagGroup;
