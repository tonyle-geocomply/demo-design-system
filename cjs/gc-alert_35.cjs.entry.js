...
const GcCellExpandable = class {
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("header", { class: { 'gc__head-opening': this.open, 'gc__head': true }, onClick: () => this.toggle() }, index$1.h("div", { class: "gc__step-item-title" }, index$1.h("div", { class: { 'transitioning-rotate': this.open, 'gc__step-item-icon': true }, onTransitionEnd: () => this.handleTransitionEnd() }, index$1.h("gc-icon", { name: "fa-regular fa-chevron-down", color: "var(--gc-color-primary)", size: "12px" })), index$1.h("div", { class: "gc__step-item-title--content" }, index$1.h("div", null, this.fieldName, ": ", index$1.h("b", null, this.value)), index$1.h("div", { class: "divider" }), index$1.h("gc-dropdown", { trigger: "hover", positions: "bottom-end" }, index$1.h("gc-link", null, index$1.h("b", null, this.total, " total ", this.totalText)), index$1.h("div", { slot: "gc__dropdown-content", style: { padding: '16px' } }, index$1.h("div", null, this.tooltipMessage)))), index$1.h("div", { class: "gc__step-item-title--entry" }, "Showing last ", this.numberOfEntryPerPage, " of ", this.total, " entries"))), index$1.h("section", { class: { 'gc__steps-section': true, 'transitioning': this.transitioning, 'open': this.open }, style: this.style }, index$1.h("div", null, index$1.h("slot", null)))));
  }
...
const GcTable = class {
  ...
  renderBodyWithExpandableRows() {
    ...
    treeData.forEach(expandedRow => {
      ...
      const expandableRows = (index$1.h("gc-cell-expandable", { class: { 'is-loading': this.loadingGroupIndex.includes(`${index}`) }, index: index, fieldName: fieldName, value: value, total: total, totalText: totalText, tooltipMessage: tooltipMessage, numberOfEntryPerPage: numberOfEntryPerPage || data.length }, this.loadingGroupIndex.includes(`${index}`) && (index$1.h("div", { class: "loading-section" }, index$1.h("gc-spinner", null))), rows));
