...
const GcDropdown = class {
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("div", { onClick: () => this.handleClick(), onMouseEnter: () => this.handleHover(), onMouseLeave: () => this.handleHover(), class: "slot-container", id: "host-element", "aria-describedby": "tooltip", ref: elm => (this.containerElm = elm) }, index$1.h("slot", null)), index$1.h("div", { onClick: () => this.handleClickDropdown(), class: "gc__dropdown-content", id: "tooltip", role: "tooltip", ref: elm => (this.dropdownElm = elm) }, this.renderItems(), index$1.h("slot", { name: "gc__dropdown-content" }), index$1.h("div", { id: "arrow", "data-popper-arrow": true }))));
  }
