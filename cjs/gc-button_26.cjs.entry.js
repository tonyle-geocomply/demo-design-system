...
const GcTable = class {
  ...
  renderColumnContent(row, column, conditionToDisplayActions) {
    ...
    if (column.isLongText || column.isCopyText) {
      return (index$1.h("div", { class: "col-text" }, index$1.h("gc-tooltip", { isCopyText: column.isCopyText, content: row === null || row === void 0 ? void 0 : row[column.name], isToggle: ((_a = this.clickedCell) === null || _a === void 0 ? void 0 : _a.row) === row && ((_b = this.clickedCell) === null || _b === void 0 ? void 0 : _b.column.name) === column.name }), this.renderActions(row, column, conditionToDisplayActions)));
    }
