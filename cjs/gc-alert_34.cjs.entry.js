...
const GcTable = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { class: { 'is-loading': this.isLoading } }, this.isLoading && (index$1.h("div", { class: "loading-section" }, index$1.h("gc-spinner", null))), this.renderSettingColumns(), this.getData().length > 0 ? (index$1.h("div", { style: { border: this.isNoBorderedAll && !this.isStripe ? '0' : '' }, class: {
        'gc__table': true,
