...
const GcFormField = class {
  ...
  renderField() {
    switch (this.type) {
      ...
      case 'textarea':
        return (index$1.h("gc-textarea", { "gc-id": this.gcId, "gc-name": this.gcName, value: this.value, disabled: this.disabled, placeholder: this.placeholder, "onGc:change": e => this.handleChange(e), "is-error": !!this.errorText }));
      default:
...
const GcTable = class {
  ...
  renderColumnContent(row, column, conditionToDisplayActions) {
    var _a, _b;
    if ((column.isLongText && (row === null || row === void 0 ? void 0 : row[column.name].length) > MAX_LONG_TEXT$1) || column.isCopyText) {
