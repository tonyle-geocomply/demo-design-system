...
const GcDropdown = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { "has-focus": this.hasFocus, "is-open": this.isOpen }, index$1.h("div", { class: {
        'dropdown': true,
        [this.position]: true,
        'is-open': this.isOpen,
      }, onMouseEnter: this.mouseEnterHandler, onMouseLeave: this.mouseLeaveHandler }, index$1.h("button", { class: "dropdown-button", onKeyDown: this.keyDownHandler, tabindex: "-1", onBlur: this.blurHandler, onFocus: this.focusHandler, disabled: this.disabled, onClick: () => {
        this.toggleList();
      } }, index$1.h("div", { class: "slot-container", ref: elm => (this.containerElm = elm) }, index$1.h("slot", null))), index$1.h("div", { class: "gc__dropdown-content", ref: elm => (this.dropdownElm = elm) }, this.renderItems(), index$1.h("slot", { name: "gc__dropdown-content" })))));
  }
...
const GcFormField = class {
  ...
  render() {
    const input = this.type === 'select' ? (index$1.h("gc-select", { search: this.search, items: this.items, "gc-id": this.gcId, "gc-name": this.gcName, value: this.value, disabled: this.disabled, placeholder: this.placeholder, "onGc:change": e => this.handleChange(e) })) : (index$1.h("gc-input", { "prefix-icon": this.prefixIcon, "gc-id": this.gcId, "gc-name": this.gcName, value: this.value, disabled: this.disabled, type: this.type, placeholder: this.placeholder, "onGc:change": e => this.handleChange(e) }));
    return (index$1.h(index$1.Host, null, index$1.h("gc-label", { "gc-for": this.gcName }, this.label), input));
  }
};
...
const GcInput = class {
  ...
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("input", { class: this.prefixIcon ? `has-prefix ${this.class}` : this.class, name: this.gcName, onInput: this.onInput, id: this.gcId, type: this.type, value: this.value, placeholder: this.placeholder, disabled: this.disabled }), this.prefixIcon && index$1.h("gc-icon", { color: "var(--gc-color-primary)", name: this.prefixIcon })));
  }
};
...
const GcLink = class {
  ...
  render() {
    if (this.icon) {
      return (index$1.h("div", { style: { display: 'flex', alignItems: 'baseline', cursor: 'pointer' } }, index$1.h("gc-icon", { name: this.icon, size: "sm", color: "#397FF7" }), index$1.h("a", { target: this.target, style: { color: this.color || 'var(--gc-color-primary)', marginLeft: '8px' }, class: this.getClassName(), id: this.gcId, href: this.gcTo }, index$1.h("slot", null))));
    }
    return (index$1.h("a", { target: this.target, style: { color: this.color || 'var(--gc-color-primary)' }, class: this.getClassName(), id: this.gcId, href: this.gcTo }, index$1.h("slot", null)));
  }
};
...
const GcSelect = class {
  ...
  render() {
    return (index$1.h(index$1.Host, { id: this.gcId, "has-value": this.hasValue(), "has-focus": this.hasFocus, "is-open": this.isOpen, position: this.position }, index$1.h("div", { class: { 'dropdown': true, 'select': true, [this.position]: true, 'is-open': this.isOpen } }, index$1.h("div", { onClick: evt => {
        evt.preventDefault();
        this.toggleList();
      }, class: {
...
const GcStep = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, null, index$1.h("header", { class: { 'gc__head-opening': this.open, 'gc__head': true, 'gc__head-opacity': opcaityCondition }, onClick: () => this.toggle() }, index$1.h("div", { class: "gc__step-item-title" }, index$1.h("div", { style: { borderColor: successCondition ? 'var(--gc-color-green)' : 'var(--gc-color-primary)' }, class: { 'transitioning-rotate': this.transitioning, 'gc__step-item-icon': true } }, successCondition ? (index$1.h("gc-icon", { name: "fa-regular fa-check", color: "var(--gc-color-green)", size: "24px" })) : (index$1.h("gc-icon", { name: this.icon, color: "var(--gc-color-primary)", size: "22px" }))), index$1.h("div", { class: "gc__step-item-title--content" }, index$1.h("div", { style: { color: successCondition ? 'var(--gc-color-green)' : 'var(--gc-color-primary)' } }, index$1.h("slot", { name: "title" })), index$1.h("slot", { name: "description" }))), !this.open && index$1.h("hr", null)), index$1.h("section", { onTransitionEnd: () => this.handleTransitionEnd(), class: { 'gc__steps-section': true, transitioning: this.transitioning }, style: this.style }, index$1.h("div", null, index$1.h("slot", null)))));
  }
...
const GcTable = class {
  ...
  renderHeader() {
    ...
    columnsWithPos.forEach(col => {
      if (this.showingColumns[col.name]) {
        ...
        const colEl = (index$1.h("div", { onClick: () => {
          ...
          }, class: { gc__col: true, sort: this.sortBy === col.name }, style: { width: colWidth, background: this.background } }, index$1.h("div", { class: "col-content" }, index$1.h("div", { class: "col-text" }, col.label), index$1.h("div", { class: "col-actions" }, (() => {
          if (!this.sortable || !col.sortable)
            return;
    ...
    return (index$1.h("div", { class: "header" }, index$1.h("div", { class: "gc__row" }, index$1.h("div", { class: "fixed-columns columns-container" }, fixedCols), index$1.h("div", { class: "scrollable-columns columns-container" }, scrollCols))));
  }
  renderBody() {
    const rows = [];
    ...
    data.forEach((row, idx) => {
      ...
      columnsWithPos.forEach(column => {
        ...
        if (this.showingColumns[column.name]) {
          ...
          const colEl = (index$1.h("div", { class: { 'gc__col': true, 'col-hover': this.hoveredCell.row === row && this.hoveredCell.column === column, 'col-center': column.center }, style: {
            ...
            return (index$1.h("gc-button", { class: `gc__btn-action ${matchCondition ? 'active' : ''}`, key: action.key, paddingText: "0 10px", height: "24px", href: action.onLink && row ? action.onLink(row) : null, disabled: action.disabled, target: action.target, "onGc:click": () => {
      ...
      rows.push(index$1.h("div", { class: { 'gc__row': true, 'row-hover': this.hoveredCell.row === row }, style: {
        ...
        } }, index$1.h("div", { class: "fixed-columns columns-container" }, fixedCols), index$1.h("div", { class: "scrollable-columns columns-container" }, scrollCols)));
    });
    return index$1.h("div", { class: "gc__table-body" }, rows);
  }
  getTotalItems() {
  ...
  renderPagination() {
    ...
    return (index$1.h("div", { class: "pagination" }, index$1.h("div", { class: "page-sizes-select" }), index$1.h("div", { class: "pagination-item-count" }, index$1.h("span", null, "Showing"), "\u00A0", this.pageSize * (this.page - 1) + 1, "\u00A0to\u00A0", this.pageSize * this.page < this.getTotalItems() ? this.pageSize * this.page : this.getTotalItems(), "\u00A0of\u00A0", totalItems, "\u00A0", totalItems <= 1 ? 'entry' : 'entries'), index$1.h("div", { class: "pagination-right" }, index$1.h("div", { class: "table-footer-right-content" }, index$1.h("div", { class: "table-footer-right-content-pagination" }, index$1.h("gc-pagination", { activePage: this.page, total: this.getTotalItems(), pageSize: this.pageSize }))))));
  }
  renderSettingColumns() {
    if (this.settingColumns && this.getData().length > 0) {
      ...
      return (index$1.h("div", { style: { background: this.background }, class: "gc__table-setting" }, index$1.h("slot", { name: "gc__table-setting-title" }, index$1.h("div", null, "Results: ", totalItems, " ", totalItems <= 1 ? 'entry' : 'entries', " found matching applied filters:")), index$1.h("div", null, index$1.h("gc-dropdown", { id: `dropdown_${this.gcId}` }, index$1.h("gc-link", { icon: "fa-solid fa-table-layout", color: "var(--gc-color-text-grey)" }, "Manage Table Columns"), index$1.h("div", { slot: "gc__dropdown-content", class: "dropdown" }, index$1.h("div", { class: "gc__table-setting-cols-text" }, index$1.h("gc-icon", { color: "red", name: "fa-regular fa-square-info" }), index$1.h("gc-h2", { class: "gc__table-setting-cols-title" }, "Manage Table Columns")), index$1.h("gc-drag-container", { "onGc:drop": this.onDrop, "class-container": "gc__table-setting-cols", "class-daggable": ".draggable-item", group: "table-setting-cols" }, columns.map(col => (index$1.h("gc-draggable-item", { "data-col-name": col.name, "data-col-check": `${this.showingColumns[col.name]}`, key: `${this.gcId}_${col.name}`, class: { 'draggable-item': !col.alwaysDisplay } }, index$1.h("div", { key: `${this.gcId}_${col.name}`, class: { 'gc__table-setting-col-item': true } }, index$1.h("gc-icon", { color: "var(--gc-color-secondary-grey)", name: "fa-solid fa-grip-dots-vertical" }), index$1.h("gc-checkbox", { disabled: col.alwaysDisplay, "gc-name": `${this.gcId}_${col.name}`, label: col.label, checked: this.showingColumns[col.name], "onGc:change": e => this.onCheck(e, col.name) })))))))))));
    }
  }
  render() {
    if (this.isLoading) {
      return (index$1.h(index$1.Host, null, this.renderSettingColumns(), index$1.h("div", { class: { 'gc__table': true, 'sortable': this.sortable, 'paginate': this.paginate, 'gc__table-no-stripe': !this.isStripe, 'gc__table-no-border': !this.isBordered } }, index$1.h("div", { class: "table-scroll-container" }, this.renderHeader(), this.renderBody(), index$1.h("div", { class: "loading-section" }, index$1.h("gc-spinner", null))), this.paginate && (index$1.h("div", { style: { background: this.background }, class: "table-footer" }, this.renderPagination())))));
    }
    return (index$1.h(index$1.Host, null, this.renderSettingColumns(), this.getData().length > 0 ? (index$1.h("div", { class: { 'gc__table': true, 'sortable': this.sortable, 'paginate': this.paginate, 'gc__table-no-stripe': !this.isStripe, 'gc__table-no-border': !this.isBordered } }, index$1.h("div", { class: "table-scroll-container" }, this.renderHeader(), this.renderBody()), this.paginate && (index$1.h("div", { style: { background: this.background }, class: "table-footer" }, this.renderPagination())))) : (this.renderEmptyState())));
  }
  renderEmptyState() {
    return (index$1.h("div", { class: "empty-table" }, index$1.h("div", { class: "empty-title" }, index$1.h("gc-h2", null, "There is no records found matching applied filters")), index$1.h("gc-button", { onClick: () => this.onClearEmptyState(), type: "secondary", icon: "fa-regular fa-filter-slash" }, "Clear applied filters")));
  }
  get elm() { return index$1.getElement(this); }
  static get watchers() { return {
