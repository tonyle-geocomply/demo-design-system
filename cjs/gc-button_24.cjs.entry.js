...
const GcTable = class {
  ...
  renderColumnContent(row, column, conditionToDisplayActions) {
    ...
    if (column.isLongText || column.isCopyText) {
      return (index$1.h("div", { onClick: () => this.onToggleTooltip(), style: { color: 'var(--gc-color-text-grey)', textDecoration: 'underline', cursor: 'pointer' }, class: { 'col-text': true, 'has-tooltip': true, 'active': this.showTooltip && ((_a = this.clickedCell) === null || _a === void 0 ? void 0 : _a.row) === row && ((_b = this.clickedCell) === null || _b === void 0 ? void 0 : _b.column.name) === column.name } }, this.renderCutText(row, column), this.renderActions(row, column, conditionToDisplayActions), index$1.h("span", { class: "tooltip-wrapper" }, index$1.h("div", { class: "tooltip" }, row === null || row === void 0 ? void 0 :
        row[column.name], column.isCopyText && (index$1.h("div", { style: { marginTop: '8px' } }, index$1.h("gc-button", { height: "29px", type: "primary", "onGc:click": () => copyClipboard(row === null || row === void 0 ? void 0 : row[column.name], () => {
