  ...
  render() {
    return (index$1.h(index$1.Host, { id: this.gcId, "has-value": this.hasValue(), "has-focus": this.hasFocus, "is-open": this.isOpen, position: this.position }, index$1.h("div", { class: { 'dropdown': true, 'select': true, [this.position]: true, 'is-open': this.isOpen } }, index$1.h("div", { onClick: evt => {
      ...
      if (this.search !== 'none' && this.isOpen) {
        return (index$1.h("input", Object.assign({ class: "input input-native", ref: input => (this.nativeInput = input), type: "text", value: this.searchString, placeholder: this.placeholder, onBlur: this.blurHandler, onFocus: this.focusHandler, onInput: this.onInput, onKeyDown: this.keyDownHandler }, this.configAria)));
      }
      else {
      ...
      columnsWithPos.forEach(column => {
        ...
        if (this.showingColumns[column.name]) {
          ...
          const colEl = (index$1.h("div", { class: { 'gc__col': true, 'col-hover': this.hoveredCell.row === row && this.hoveredCell.column === column, 'col-center': column.center }, style: {
            ...
            } }, index$1.h("div", { class: "col-content" }, index$1.h("div", { class: "col-text", innerHTML: row === null || row === void 0 ? void 0 : row[column.name] }, conditionToDisplayActions ? index$1.h("div", { class: "gc__actions" }, column.actions.map(action => {
            return (index$1.h("gc-button", { class: "gc__btn-action", key: action.name, paddingText: "0 10px", height: "24px", "onGc:click": () => {
                action.onClick(row);
